...
{time}',
    ...
    'transferstatus' => true,
    'ucenterurl' => 'http://45.33.44.158/uc_server',
    'tradeopen' => 1,
    'medalstatus' => 0,
    'plugins' => 
    array (
        ...
        array (
          ...
          array (
            ...
            array (
              ...
              array (
                0 => 'xlmmylt',
                1 => 'forumdisplay_thread_subject_output',
              ),
            ),
          ),
        ),
    ...
    array (
      ...
      array (
        ...
        array (
          'available' => '1',
          'navname' => '收藏本站',
          'code' => '<a href="http://zy888.org/"  onclick="addFavorite(this.href, \'资源岛\');return false;">收藏本站</a>',
          'type' => '0',
          'level' => '0',
          'id' => 'setfavorite',
        ),
...
{iUczYH4q}
<dl class="pil cl">
	<dt>{f5G1g3M4}</dt><dd>{snK088fb}</dd>
</dl>
{kD4f926y}
<dl class="pil cl">{WKQf5kMP}</dl>',
          'top' => '<dl class="cl">
<dt>{FVo9ldCo}</dt><dd>{Pw2d3021}</dd>
</dl>',
        ),
      ),
      'code' => 
